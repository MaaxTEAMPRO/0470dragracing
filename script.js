document.addEventListener("DOMContentLoaded", () => {
    ...
    let boost = 0;  // Nivel de boost (0 a 1)
    let power = 5;  // Potência (downforce) (0 a 1)
    let suspensionFront = 0.5;  // Altura suspensão dianteira (0 a 1)
    let suspensionRear = 0.5;  // Altura suspensão traseira (0 a 1)
    let selectedVehicle = "🚗";
